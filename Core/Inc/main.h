...
#define SwAL_Pin GPIO_PIN_7
#define SwAL_GPIO_Port GPIOA
#define SwBL_Pin GPIO_PIN_0
#define SwBL_GPIO_Port GPIOB
#define SwCL_Pin GPIO_PIN_1
...
#define SwAH_Pin GPIO_PIN_8
#define SwAH_GPIO_Port GPIOA
#define SwBH_Pin GPIO_PIN_9
#define SwBH_GPIO_Port GPIOA
#define SwCH_Pin GPIO_PIN_10
#define SwCH_GPIO_Port GPIOA
